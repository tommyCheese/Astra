...
from app.common.schemas.permissions import ActionEffectPlan, EffectKind
from app.infrastructure.db.model_base import utc_now
from app.infrastructure.db.models.executions import ResourceLeaseRecord
...
def resource_claims_from_effect_plan(plan: ActionEffectPlan) -> tuple[ResourceClaim, ...]:
    ...
    return tuple(claims[key] for key in sorted(claims, key=lambda item: (item[0], item[1])))
