...
from app.schemas.agent.tool_invocation import PendingApprovalView
from app.schemas.agent.types import AnswerMode, ContinuationAction, PlanExecution
...
MemoryView.__module__ = "app.schemas.agent"
