"""OpenAI-compatible HTTP transport and streaming parser."""
...
from app.infrastructure.model_clients.normalization import StreamingJsonFieldExtractor
from app.infrastructure.model_clients.reasoning import ModelReasoningConfig, attach_reasoning_usage
