...
const english: Record<string, string> = {
  ...
  '思考过程': 'Reasoning process', '{steps} 个步骤 · {tools} 次工具调用': '{steps} steps · {tools} tool calls', '思考': 'Reasoning', '验证': 'Verification', '来源 · {count}': 'Sources · {count}', '运行工件': 'Run artifacts', '预览加载失败': 'Preview failed to load', '隔离预览': 'Isolated preview',
