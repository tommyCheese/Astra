# governed-subagent-runtime Specification

## Purpose
Define governed, isolated and recoverable child Agent execution with attenuated authority, auditable lineage and verifiable results.
